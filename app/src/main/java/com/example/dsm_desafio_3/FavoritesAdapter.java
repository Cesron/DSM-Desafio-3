...
public class FavoritesAdapter extends RecyclerView.Adapter<FavoritesAdapter.MyViewHolder> {
    ...
    FavoritesAdapter(Activity activity, Context context, ArrayList id, ArrayList model, ArrayList vin,
    ...
    @Override
    public void onBindViewHolder(@NonNull FavoritesAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
