...
public class ClientAdapter extends RecyclerView.Adapter<ClientAdapter.MyViewHolder> {
    ...
    ClientAdapter(Activity activity, Context context, ArrayList id, ArrayList model, ArrayList vin,
    ...
    @Override
    public void onBindViewHolder(@NonNull ClientAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
